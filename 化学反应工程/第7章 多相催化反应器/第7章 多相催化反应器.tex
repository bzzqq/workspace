...
\maketitle
    ...
    \begin{frame}
        ...
        本章讨论催化反应器的设计与分析，且只限于采用固体催化剂的反应过程。
...
\begin{frame}
    \frametitle{填料塔中使用的填料}
    \begin{figure}[htpb]
        \centering
        \setcounter{subfigure}{0}
        \subfloat[拉西环]{\includegraphics[height=5cm]{拉西环}}\quad
        \subfloat[鲍尔环]{\includegraphics[height=5cm]{鲍尔环}}
    \end{figure}
\end{frame}
...
\begin{frame}
    \frametitle{固定床的压降}
    压力降是指流体（气体或液体）在流过一段管道、设备或填料层时，由于克服流动阻力而导致的压力损失。
...
\input{sections/7.5.tex}
\input{sections/7.6.tex}
\input{sections/7.7.tex}
\input{sections/7.8.tex}
